...
Start-Process -Wait -FilePath .\setup.exe -ArgumentList "-s nvcc_11.3 cublas_11.3 cublas_dev_11.3 cudart_11.3 curand_11.3 curand_dev_11.3 nvml_dev_11.3"
